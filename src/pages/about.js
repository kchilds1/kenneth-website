...
export default function About() {
  ...
  return (
    <Layout>
        ...
        <meta name="about" content="website about" />
      ...
      <Box>
        ...
        <Box className={styles.text}>
          Welcome to my corner of the web! I'm Kenneth Childs Jr., a highly
          ...
          array of programming languages and technologies, ensuring I'm
          ...
          possibilities of web development. Whether you're here to appreciate my
        ...
        >
          <Typography variant="h4" sx={{ color: "white", paddingTop: "10px" }}>
            ...
            <Box className={styles.text}>
              Name: Kenneth Childs Jr
              Address: Tulsa, OK
              Email: Kenneth.Childs20@gmail.com
            </Box>
          </Typography>
          <Box sx={{ width: 150 }}>
            <Lottie
